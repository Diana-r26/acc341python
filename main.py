...
cursor.execute("SELECT c.company_name, SUM(i.total_amount) AS total_billed FROM invoice i JOIN customer c ON i.customer_id = c.customer_id GROUP BY c.company_name;")
